...
archivo = "PUNR overdue 20230426" #Nombre del archivo, esto puede cambiarse a un input
...
print('Confidence level: 95% (5% chance to reject the Null Hypothesis when it is true).\n')
print("For the First ANOVA the p value is " + str(pvalue1) +'\n')
if pvalue1 <= alpha:
...
print('Confidence level: 95% (5% chance to reject the Null Hypothesis when it is true).\n')
print("For the second ANOVA the p value is " + str(pvalue2) +'\n')
if pvalue2 <= alpha:
    print('The p-value is less than the alpha value: Null Hypothesis is rejected. \nThere is a significant difference between the 2 types of causes.\n')
else:
