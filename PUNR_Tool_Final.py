...
################################################  Treemap para ver distribución de tipos de causa
...
pio.renderers.default='svg' #cambiar por 'browser' para ver online
fig.show()


################################################   gráfico de barras apiladas/agrupadas: agrupar en tipo de causas   
...
################################################ BARRAS AGRUPADAS PARA VER TODA LA INFO ANTERIOR EN 1 SOLO
...
stat1, p1, dof1, expected1 = stats.chi2_contingency(crosstab1) #VER COMO HAGO PARA IMPRIMR SOLO LO QUE ME IMPORTA (P VALUE, ARRAY, ETC)
...
stat2, p2, dof2, expected2 = stats.chi2_contingency(crosstab2) #VER COMO HAGO PARA IMPRIMR SOLO LO QUE ME IMPORTA (P VALUE, ARRAY, ETC)
alpha = 0.05 #Porcentaje de confianza del 95%
